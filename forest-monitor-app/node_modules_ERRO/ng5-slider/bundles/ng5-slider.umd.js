(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('rxjs'), require('@angular/core'), require('rxjs/operators'), require('detect-passive-events'), require('@angular/forms'), require('@angular/common')) :
	typeof define === 'function' && define.amd ? define('ng5-slider', ['exports', 'rxjs', '@angular/core', 'rxjs/operators', 'detect-passive-events', '@angular/forms', '@angular/common'], factory) :
	(factory((global['ng5-slider'] = {}),global.rxjs,global.ng.core,global.Rx.Observable.prototype,global.detectPassiveEvents,global.ng.forms,global.ng.common));
}(this, (function (exports,rxjs,core,operators,detectPassiveEvents,forms,common) { 'use strict';
